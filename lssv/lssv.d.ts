import { Entity, Props, Condition, LSSVEvent } from './types';
declare class lssv {
    /**
     ...
     */
    addEntity: (entityName: string, entityProps: Props, listenTo?: boolean, storage?: Storage) => Promise<boolean>;
    /**
...
* Retrieves first instance that fulfills a given condition
    ...
    /**************************************************** */
    /**************************************************** */
    migrateInstances: (entityName: string) => void;
    convertJSON: () => void;
    /**
...
*/
     ...
     * @version 1.1.7
     */
    createLssvEvent: (entityName: string, description: string, storage?: Storage) => void;
    private addListener;
